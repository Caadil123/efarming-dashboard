...
import { Plus, Users, Shield, Check, MoreVertical, Edit, Trash2, AlertTriangle, X, Briefcase, FileText } from "lucide-react";
...
export default function TeamPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                setShowModal(false);
                setFormData({ name: "", title: "", description: "", imageUrl: "", isActive: true });
        ...
        <div className="space-y-6 relative">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500">Manage your organizational team members</p>
                </div>
                <button
                    onClick={openModal}
